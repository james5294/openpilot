...
def get_T_FOLLOW(aggressive_follow=0.75, standard_follow=1.10, relaxed_follow=1.50, custom_personalities=False, personality=log.LongitudinalPersonality.standard):
  if custom_personalities:
    if personality==log.LongitudinalPersonality.relaxed:
