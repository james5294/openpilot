...
def create_ccnc(packer, CAN, openpilotLongitudinalControl, enabled, hud, leftBlinker, rightBlinker, msg_161, msg_162, msg_1b5, is_metric, out):
  """
  ccNC (connected car Navigation Cockpit) cluster communication for 2024+ Hyundai vehicles.
  Controls lane animations, curvature display, blind spot icons, and HUD elements.
  """
  # Suppress fault alerts from the cluster
  ...
  # Lane position animation during lane changes
  ...
  # Haptic feedback for lane departures
  if hud.leftLaneDepart or hud.rightLaneDepart:
    msg_162["VIBRATE"] = 1

  # Longitudinal HUD elements (set speed, lead car, distance)
